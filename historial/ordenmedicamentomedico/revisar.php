...
$titulo="Notas de Ordenes Médicas y Tratamientos";
$folder="../../";
...
<script language="javascript" type="text/javascript" src="../../js/historial/ordenmedicas.js"></script>
...
<fieldset>
	<legend>Orden Médicas y Tratamientos</legend>
    <hr />
    <table class="tablalistado">
    	<th><tr class="cabecera"><td width="150">Fecha</td><td>Hora</td><td>Ordenes Médicas y Tratamientos</td></tr></th>
        <tr>
        	<td style="vertical-align:top"><?php campos("","fechaevolucion","date",hoy(0),0,array_merge($alta,array()));?></td>
            <td style="vertical-align:top"><?php campos("","horaevolucion","time",date("H:i:s"),0,array_merge($alta,array("style"=>"width:100px")));?></td>
            <td><?php campos("","ordenmedica","textarea","",0,array_merge($alta,array("cols"=>30,"rows"=>10,"placeholder"=>"Ingrese su Orden Médica y Tratamiento")));?></td>
             <?php if($hist['alta']==0){?>
            <td><a href="" class="botoninfo" id="guardarm">>></a></td>
            <?php }?>
        </tr>
    </table>
    <a href="ver.php?id=<?php echo $idhistorialinterno?>" class="botonerror">Impresión Ordenes Médicas</a>
