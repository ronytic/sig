...
<fieldset>
    <table class="tablalistado">
    	<th><tr class="cabecera"><td>Nº</td><td width="250">Medicamento</td><td>Total</td><td>Cantidad</td><td>Cada</td><td>Durante</td><td width="500">Compra</td><td>Fecha Compra</td></tr></th>
...
$tf=array_shift($tipofarmacia->mostrar($m['idtipofarmacia']));
    ...
    <tr class="contenido">
        ...
        <td class="centrar"><?php echo $rm['total']?></td>
