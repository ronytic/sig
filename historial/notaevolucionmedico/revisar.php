...
$titulo="Notas de Evolución Medico";
$folder="../../";
...
<script language="javascript" type="text/javascript" src="../../js/historial/notaevolucion.js"></script>
...
<fieldset>
	<legend>Notas de Evolución</legend>
    <hr />
    <table class="tablalistado">
    	<th><tr class="cabecera"><td width="150">Fecha</td><td>Hora</td><td>Notas Evolución</td></tr></th>
        <tr>
            ...
            <td><?php campos("","notaevolucion","textarea","",0,array_merge($alta,array("cols"=>30,"rows"=>10,"placeholder"=>"Ingrese su Nota de Evolución")));?></td>
            <?php if($hist['alta']==0){?>
            <td><a href="" class="botoninfo" id="guardarm">>></a></td>
            <?php }?>
        </tr>
    </table>
    <a href="ver.php?id=<?php echo $idhistorialinterno?>" class="botonerror">Impresión Nota Evolución</a>
