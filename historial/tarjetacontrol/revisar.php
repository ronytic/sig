...
$titulo="Notas de Tarjeta de Control";
$folder="../../";
...
<script language="javascript" type="text/javascript" src="../../js/historial/tarjetacontrol.js"></script>
...
<fieldset>
	<legend>Notas de Tarjeta de Control</legend>
    <hr />
    <table class="tablalistado">
    	<th><tr class="cabecera"><td width="150">Fecha Hora Medicación</td><td>Orden.</td></tr></th>
        <tr>
        	<td style="vertical-align:top">
                ...
                <?php campos("Dato","dato","text","",0,array_merge($alta,array("size"=>"20","maxlength"=>"100")),"",1);?><br />
				<?php campos("Discontinuo","discontinuo","text","",0,array_merge($alta,array("size"=>"20","maxlength"=>"100")),"",1);?></td>
            <td><?php campos("","ordenes","textarea","",0,array_merge($alta,array("cols"=>30,"rows"=>10,"placeholder"=>"Ingrese su Orden")));?></td>
            <?php if($hist['alta']==0){?>
            <td><a href="" class="botoninfo" id="guardarm">>></a></td>
            <?php }?>
        </tr>
    </table>
    <a href="ver.php?id=<?php echo $idhistorialinterno?>" class="botonerror">Impresión Tarjeta de Control</a>
