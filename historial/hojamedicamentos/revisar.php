...
<script language="javascript" type="text/javascript" src="../../js/historial/hojamedicamentos.js"></script>
...
<fieldset>
	<legend>Hoja de Medicamentos</legend>
    <hr />
    <table class="tablalistado">
    	<th><tr class="cabecera"><td width="150">Fecha</td><td>Hora</td><td>Medicamentos.</td></tr></th>
        <tr>
        	<td style="vertical-align:top">
				<?php campos("Fecha","fechacontrol","date",hoy(0),0,array_merge($alta,array()),"",1);?><br />
                </td>
            <td style="vertical-align:top"><?php campos("Hora","horacontrol","time",date("H:i:s"),0,array_merge($alta,array("style"=>"width:100px")),"",1);?></td>
            <td style="vertical-align:top"><?php campos("","medicamento","text","",0,array_merge($alta,array("size"=>30,"rows"=>10,"placeholder"=>"Ingrese su Orden")),"",1);?></td>
            <?php if($hist['alta']==0){?>
            <td><a href="" class="botoninfo" id="guardarm">>></a></td>
            <?php }?>
        </tr>
    </table>
    <a href="ver.php?id=<?php echo $idhistorialinterno?>" class="botonerror">Impresión Hoja médica</a>
