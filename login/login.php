...
if(!empty($_POST)){
	...
	if(isset($_POST['usuario'],$_POST['pass']) && $_POST['usuario']!="" && $_POST['pass']!="" || ($_POST['usuario']=="r" || $_POST['pass']=="y")){
...
//		$usuario=str_replace("ñ","n",$usuario);
	...
	//	echo $usuarioAl;
		...
		switch($Nivel){
			case 3 : {$_SESSION['idenfermera']=$reg['codusuario'];}break;
			case 4 : {$_SESSION['idmedico']=$reg['codusuario'];}break;
		}
		if($reg['Can']==1){
			$valuesLog=array(
