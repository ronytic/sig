	...
	<div class="contenido">
            ...
            <form id="busqueda" action="busqueda.php" method="post" >
                <table class="tablabus">
                    <tr>
						<td><?php campos("Nivel","nivel","select",array(""=>"Seleccionar",3=>"Enfermera",4=>"Medico"),0,"","",1);?></td>
                        <td><?php campos("Turno","turno","select",array(""=>"Seleccionar","M"=>"Mañana","T"=>"Tarde","N"=>"Noche"),0,"","",1);?></td>
