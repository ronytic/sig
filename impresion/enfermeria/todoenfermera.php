...
class PDF extends FPDF{
	...
	function Header(){
		...
		$this->Cell(200,10,utf8_decode("Datos de Enfermeros"),0,0,"C");
		$this->Ln(15);
		...
		$this->Cell(20,5,utf8_decode("Fecha Ingreso"),1,0,"C");
		$this->Cell(30,5,utf8_decode("Nivel Profesional"),1,0,"C");
...
//	$pro=array_shift($proveedor->mostrar($med['idproveedor']));
	...
	$pdf->Cell(20,5,utf8_decode(ucwords(mb_strtolower(date("d-m-Y",strtotime($pac['fechain'])),"utf8"))),1,0,"L");
	$pdf->Cell(30,5,utf8_decode(ucwords(mb_strtolower($pac['nivelprof'],"utf8"))),1,0,"L");
