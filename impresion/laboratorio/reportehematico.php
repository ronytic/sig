...
$pdf->SetXY(35,62);
$pdf->MultiCell(45,5,utf8_decode($se['cuadrohematico1']),0,"C");

$pdf->SetXY(115,62);
$pdf->MultiCell(45,5,utf8_decode($se['cuadrohematico2']),0,"C");

$pdf->SetXY(15,150);
$pdf->MultiCell(135,5,utf8_decode($se['otrosresultados']),0,"L");
