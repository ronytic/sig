...
$prov=array_shift($proveedor->mostrar($dato['idproveedor']));
$tipof=array_shift($tipofarmacia->mostrar($dato['idtipofarmacia']));
...
$pdf->Cell(150,10,utf8_decode("Datos de Medicamento"),0,0,"C");
$pdf->Ln(15);
...
$datos=array(
				"Nombre Medicamento"=>$dato['nombre'],
				"Precio "=>$dato['preciounitario']." Bs.",
				"Tipo Medicamento"=>$tipof['nombre'],
