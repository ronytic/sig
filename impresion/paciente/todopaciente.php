...
class PDF extends FPDF{
	...
	function Header(){
		...
		$this->Cell(200,10,utf8_decode("Datos de Todos los Pacientes"),0,0,"C");
		$this->Ln(15);
		...
		$this->Cell(30,5,utf8_decode("C.I."),1,0,"C");
		$this->Cell(20,5,utf8_decode("Fecha Nac"),1,0,"C");
		$this->Cell(20,5,utf8_decode("Sexo"),1,0,"C");
...
//	$pro=array_shift($proveedor->mostrar($med['idproveedor']));
	...
	$pdf->SetFont("arial","",8);
	$pdf->Cell(50,5,utf8_decode(ucwords(mb_strtolower($pac['apep'],"utf8"))),1,0,"L");
	$pdf->Cell(50,5,utf8_decode(ucwords(mb_strtolower($pac['apem'],"utf8"))),1,0,"L");
	$pdf->Cell(50,5,utf8_decode(ucwords(mb_strtolower($pac['nombre'],"utf8"))),1,0,"L");
	$pdf->Cell(30,5,utf8_decode((mb_strtolower($pac['ci'],"utf8"))),1,0,"L");
	$pdf->Cell(20,5,utf8_decode(ucwords(mb_strtolower(date("d-m-Y",strtotime($pac['fecnac'])),"utf8"))),1,0,"L");
	$pdf->Cell(20,5,utf8_decode(ucwords(mb_strtolower($pac['sexo'],"utf8"))),1,0,"L");
