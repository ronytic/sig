...
<?php include($folder."lateral.php");?>
    ...
    <div class="contenido">
        ...
        <table class="tablareg">
			...
			<tr><td class="der">Ap.Materno</td><td><input type="text" name="materno" value="<?php echo $pa['apem'];?>"></td><td class="separador">C.I.</td><td><input type="text" name="ci" size="10" value="<?php echo $pa['ci'];?>"><span class="pequeno">Solo números Ej:4455336</span></td></tr>
			<tr><td class="der">Direccion</td><td><input type="text" name="direccion" value="<?php echo $pa['direccion'];?>"></td><td class="separador">Telefono</td><td><input type="text" name="fono" value="<?php echo $pa['telefono'];?>"></td></tr>
			...
			<tr><td class="der">Ocupacion</td><td><input type="text" name="ocu" value="<?php echo $pa['ocup'];?>"></td><td class="separador"></td><td></td></tr>
			<tr><td class="der">Persona Referencia</td><td><input type="text" name="ref" id="ref" value="<?php echo $pa['refper'];?>"></td><td class="separador">Telefono Referencia</td><td><input type="text" name="reffono" value="<?php echo $pa['reffono'];?>"></td></tr>
