...
<?php include($folder."lateral.php");?>
    ...
    <div class="contenido">
        ...
        <table class="tablareg">
			...
			<tr><td class="der">Ap.Materno</td><td><input type="text" name="apm" required></td><td class="separador">C.I.</td><td><input type="text" name="ci" size="10"><span class="pequeno">Solo números Ej:4455336</span></td></tr>
			<tr><td class="der">Direccion</td><td><input type="text" name="dir" required></td><td class="separador">Telefono</td><td><input type="text" name="fono"></td></tr>
			...
			<tr><td class="der">Ocupacion</td><td><input type="text" name="ocu" required></td><td class="separador"></td><td></td></tr>
			<tr><td class="der">Persona Referencia</td><td><input type="text" name="ref" id="ref" required></td><td class="separador">Telefono Referencia</td><td><input type="text" name="reffono"></td></tr>
