...
if (!empty($_POST)) {
	...
	listadoTabla($titulo,$datos,1,"","","",array("Llenar Resultados"=>"llenar.php","Reporte Orina"=>"reporteorina.php","Reporte Hematico"=>"reportehematico.php","Reporte General"=>"reportegeneral.php"));
}
?>